...
const NotificationScreen = () => {
    ...
    return (
      ...
      >
        ...
        <View className="flex-1">
          <Text className={`text-base ${!item.isRead ? 'font-semibold text-gray-900' : 'text-gray-700'}`}>
            {item.message}
          </Text>
        ...
        <Ionicons name="chevron-forward" size={20} color="#ccc" className="ml-2" />
      </TouchableOpacity>
    );
  };
  ...
  const renderEmpty = () => (
    <View className="flex-1 items-center justify-center py-20">
      ...
      <Text className="text-xl font-semibold text-gray-400 mt-4">No notifications</Text>
