...
const ChatScreen = () => {
  ...
  const renderMessage = ({ item, index }) => {
    ...
    const showTime = index === messages.length - 1 || messages[index + 1].senderId !== item.senderId;
    ...
    return (
      <View style={[
        ...
        {!isCurrentUser && showAvatar && (
          <Image source={{ uri: partnerData.avatarUrl }} style={styles.messageAvatar} />
        )}
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.headerContent}>
          <Image source={{ uri: partnerData.avatarUrl }} style={styles.headerAvatar} />
          <View style={styles.headerInfo}>
            <Text style={styles.headerName}>{partnerData.name}</Text>
            <Text style={styles.headerStatus}>
              {partnerData.isOnline ? "Online" : `Last seen ${formatTime(partnerData.lastSeen)}`}
            </Text>
          </View>
        </TouchableOpacity>
